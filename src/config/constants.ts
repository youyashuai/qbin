...
export const jwtSecret = get_env("JWT_SECRET") || "123";  // 从环境变量获取jwt密钥
export const exactPaths = ["/favicon.ico", "/document"]
export const prefixPaths = ['/r/', '/static/', '/api/login/']
...
export const ADMIN = {[PASSWORD]: EMAIL,};
